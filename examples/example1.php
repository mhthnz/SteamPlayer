...
echo 'avatarsmall: <img src="'.$player->avatar(SteamPlayer::AVATAR_SMALL).'">'."<br/>\r\n";
echo 'avatarmedium: <img src="'.$player->avatar(SteamPlayer::AVATAR_MEDIUM).'">'."<br/>\r\n";
echo 'countrycode: <img src="'.$player->avatar(SteamPlayer::AVATAR_LARGE).'">'."<br/>\r\n";
